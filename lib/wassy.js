...
/***/ function(module, exports, __webpack_require__) {
	...
	var RequestBuilder = __webpack_require__(4);
	...
	Model.request = function(urlBindings) {
	  ...
	  var RQ = RequestBuilder.extend(CurrentClass.config);
	
	  var builder = new RQ(CurrentClass.config);
	...
	Model.extends = function(settings) {
	  ...
	  NewModelClass.config = _.clone(this.config);
	  _.extend(NewModelClass.config, settings.config);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Request = Class.extend({
	  ...
	  init: function(params) {
	    ...
	    this.config = defConfig.clone(params);
	  },
	  ...
	  send: function (method, params, headers) {
	    ...
	    if (_.isFunction(this.onBeforeRequest)) {
	      var _httpObj = {
	        method: method,
	        params: params,
	        headers: httpHeaders,
	      ...
	      this.onBeforeRequest.call(_httpObj);
	    }
	...
	Request.config = function(params) {
	
	  if (!params) {
	    return defConfig ;
	  }
	  defConfig = defConfig.clone(params);
	};
...
/***/ function(module, exports) {
	...
	var KaaaClass = function(options) {
	    this.options = options || {};
	    this.init.apply(this, arguments);
	}
	
	_.extend(KaaaClass.prototype, Events, {
	...
	KaaaClass.extend = extend;
	
	module.exports = KaaaClass
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (params) {
	  ...
	  return new Config().clone(params);
	};
