...
module.exports = { Endpoint: _endpoint2.default, Model: _model2.default };
...
var resolveUrl = function resolveUrl(options, urlBindings) {
...
var define = function fn(options) {
  ...
  return function (_HttpClient) {
    ...
    function Endpoint(urlBindings) {
      ...
      _this.url = resolveUrl(options, _this.urlBindings);
      return _this;
    }
...
var _requestAdaptor = __webpack_require__(8);
...
var HttpClient = function () {
  ...
  _createClass(HttpClient, [{
    ...
    key: 'postJSON',
    value: function postJSON(params, headers) {
      headers = headers || {};
    ...
    key: 'putJSON',
    value: function putJSON(params, headers) {
      headers = headers || {};
      headers['Content-Type'] = 'application/json';
    ...
    key: 'removePostRequests',
    value: function removePostRequests() {
      this.postRequest = {};
    }
  }, {
    key: 'send',
    value: function send(method, params, headers) {
      ...
      return _requestAdaptor.request.call(this, options, this.model);
    }
  }]);
...
exports.request = exports.createModel = exports.normalizeHeaders = undefined;
 ...
 * @returns {null}
 */
var normalizeHeaders = function normalizeHeaders(headersAsText) {
  if (!headersAsText) {
    return null;
  }
  var headers = {};
  var lines = headersAsText.split('\n');
  _lodash2.default.each(lines, function (item) {
 ...
 * @returns {*}
 */
var createModel = function createModel(responseData, modelProperties) {
 ...
 * @param postHandlers
 */
var handlePostRequest = function handlePostRequest(err, response, jqXHR, postHandlers) {
  var code = _lodash2.default.get(response, 'status');
...
var request = function request(opts, modelDefinition) {
  ...
  _jquery2.default.ajax({
    ...
    var response = makeResponseObject(jqXHR);
    ...
    if (_lodash2.default.isArray(data)) {
      ...
      _lodash2.default.each(data, function (obj) {
        var respItem = createModel(obj, modelDefinition);
        model.push(respItem);
      });
